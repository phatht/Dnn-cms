...
<dnn:DnnCssInclude ID="DnnCssColorScheme" runat="server" FilePath="assets/css/colors/deep-blue.min.css" PathNameAlias="SkinPath" Name="colorscheme" Version="1.0.0" />
<!-- Theme pre-defined color scheme -->