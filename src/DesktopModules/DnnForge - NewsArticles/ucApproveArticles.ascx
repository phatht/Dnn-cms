...
<asp:datagrid id=grdArticles runat="server" summary="Articles Design Table" EnableViewState="True" AutoGenerateColumns="false" cellspacing="2" CellPadding="2" Border="0" DataKeyField="ArticleID" Width="100%" GridLines="Both" CssClass="table table-striped table-bordered">
	<Columns>
		<asp:TemplateColumn ItemStyle-Width="20">
			<ItemTemplate>
				...
				<i class="fa fa-pencil" aria-hidden="true"></i></asp:HyperLink>
			</ItemTemplate>
		</asp:TemplateColumn>
...
<p align="center">
	<asp:linkbutton id="cmdApproveSelected" resourcekey="cmdApproveSelected" runat="server" cssclass="btn btn-success" text="Approve Selected Articles" causesvalidation="False" borderstyle="none" />&nbsp;
	<asp:linkbutton id="cmdApproveAll" resourcekey="cmdApproveAll" runat="server" cssclass="btn btn-primary" text="Approve All Articles" borderstyle="none" />
</p>
