                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:RegularExpressionValidator
                                            ID="fupFileValidator" runat="server"
                                            ErrorMessage="Chỉ được upload hình ảnh(.png,.jpg,.gif)"
                                            ValidationExpression="(.*\.([Jj][Pp][Gg])|.*\.([Jj][Pp][Ee][Gg])$)"
                                            ControlToValidate="fupFile" ForeColor="Red">  
                                        </asp:RegularExpressionValidator>
                                        <br />
                                        <asp:Label ID="lblFileError" ForeColor="Red" runat="server" EnableViewState="False" Visible="false"/>
                                ...
                                <tr>
                                    <td>
                                        <dnn:URL ID="ctlImage" runat="server" Width="275" Required="False" ShowTrack="False" ShowNewWindow="False"
                                            ShowLog="False" UrlType="F" ShowUrls="False" ShowFiles="True" ShowTabs="False" ShowUpLoad="True" FileFilter="jpg,gif,png"></dnn:URL>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
