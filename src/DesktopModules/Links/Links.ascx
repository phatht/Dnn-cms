...
<asp:Panel ID="pnlList" runat="server" CssClass="link_module" >
    <asp:Repeater ID="lstLinks" runat="server" OnItemDataBound="lstLinks_ItemDataBound">
        <HeaderTemplate>
            <ul id="ulHeader" class="angle-double-list<%# Horizontal %>" >
        </HeaderTemplate>
        <ItemTemplate>
...
<asp:Panel ID="pnlDropdown" runat="server">
	...
	<div class="input-group mb-3">
		<asp:DropDownList ID="cboLinks" runat="server" DataTextField="Title"  DataValueField="ItemID"
			CssClass="custom-select NormalTextBox">
		</asp:DropDownList>
		<div class="input-group-append"> 
			<asp:LinkButton ID="cmdGo" runat="server" CssClass="btn btn-outline-secondary CommandButton" OnClick="cmdGo_Click" >xem</asp:LinkButton>
		</div> 
	</div>
