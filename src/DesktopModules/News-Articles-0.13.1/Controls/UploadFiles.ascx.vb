...
#Region " Event Handlers "
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            Try
                ...
                trUpload.Visible = ArticleSettings.EnablePortalFiles
        ...
        Protected Sub btUpload_Click(sender As Object, e As EventArgs)
            ...
            Dim allowFileWhitelist As FileExtensionWhitelist = objPortalSettings.AllowedExtensionsWhitelist

            For Each file As HttpPostedFile In fupFile.PostedFiles
                If allowFileWhitelist.IsAllowedExtension(file.FileName.Split("."c)(file.FileName.Split("."c).Length - 1)) Then
                ...
                Else
                    ...
                    lblFileError.Text = "File không hợp lệ"
                End If
