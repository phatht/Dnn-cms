...
<div align="left">
    ...
    <asp:Repeater ID="rptMonth" Runat="server" EnableViewState="False">
	    ...
	    <ItemTemplate>
                ...
                <a href="<%# GetMonthLink(DataBinder.Eval(Container.DataItem, "Month"), DataBinder.Eval(Container.DataItem, "Year")) %>"><%#DataBinder.Eval(Container.DataItem, "Month")%> - <%#DataBinder.Eval(Container.DataItem, "Year")%> (<%#DataBinder.Eval(Container.DataItem, "Count")%>)</a>
                <br />
        </ItemTemplate>
        <FooterTemplate>
            </div>
