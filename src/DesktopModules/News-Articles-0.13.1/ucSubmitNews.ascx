	...
	<td valign="top" width="100%">
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:LinkButton ID="cmdSaveArticle" runat="Server" CssClass="btn btn-primary" ResourceKey="cmdUpdate" />&nbsp;&nbsp;<asp:LinkButton ID="cmdPublishArticle" runat="Server" CssClass="btn btn-secondary" ResourceKey="cmdPublish" />&nbsp;&nbsp;<asp:LinkButton ID="cmdAddEditPages" runat="Server" CssClass="btn btn-info" ResourceKey="cmdAddEditPages" />&nbsp;&nbsp;<asp:LinkButton ID="cmdCancel" runat="Server" CssClass="btn btn-secondary" ResourceKey="cmdCancel" CausesValidation="False" />&nbsp;&nbsp;<asp:LinkButton ID="cmdDelete" runat="Server" CssClass="btn btn-danger" ResourceKey="cmdDelete" CausesValidation="false" />
            </td>
        </tr>
        </table>
    </td>
