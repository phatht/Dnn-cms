                ...
                If iPtr < layoutArray.Length - 1 Then
                    Select Case layoutArray(iPtr + 1)
                        ...
                        Case "EDIT"
                            ...
                            If IsEditable OrElse (ArticleSettings.IsApprover And objArticle.ApproverID = UserId) OrElse (objArticle.AuthorID = UserId And ArticleSettings.IsAutoApprover) Then
