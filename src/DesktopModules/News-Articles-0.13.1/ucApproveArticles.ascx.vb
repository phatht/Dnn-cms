...
#Region " Private Methods "
        ...
        Private Sub BindArticles()
                ...
                If (objCategory.InheritSecurity = False) Then
                    If (Request.IsAuthenticated) Then
                        If (Settings.Contains(objCategory.CategoryID & "-" & ArticleConstants.PERMISSION_CATEGORY_SUBMIT_SETTING)) Then
                            If (PortalSecurity.IsInRoles(Settings(objCategory.CategoryID & "-" & ArticleConstants.PERMISSION_CATEGORY_SUBMIT_SETTING).ToString()) = False) Then
            ...
            If (catsExclude Is Nothing) Then
                ...
                End If
            End If
            grdArticles.DataSource = objArticleController.GetArticleList(Me.ModuleId, Null.NullDate, Null.NullDate, Nothing, Null.NullBoolean, catsExclude, Null.NullInteger, CurrentPage, 20, "StartDate", "DESC", False, Null.NullBoolean, Null.NullString, Null.NullInteger, True, True, Null.NullBoolean, Null.NullBoolean, False, False, Null.NullString, Nothing, False, Null.NullString, Null.NullInteger, Null.NullString, Null.NullString, count)
